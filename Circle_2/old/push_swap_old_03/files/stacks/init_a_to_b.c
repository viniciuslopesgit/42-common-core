...
/*   Updated: 2025/02/24 02:19:13 by viniciuslop      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	set_target_a(node *a, node *b)//Find `a` node's target in stack `b`
{
	node	*current_b; //To store the pointer to the current node in stack `b` and iterate through each node following
	node	*target_node; //To store the pointer to the target node in stack `b`
