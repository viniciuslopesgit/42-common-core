...
/*   Updated: 2025/02/24 02:38:31 by viniciuslop      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_three(node **a) //Define a function that handles when stack `a` has three nodes, and sorts it
{
...
static void	rotate_both(node **a,
						node **b,
						node *cheapest_node) //Define a function that rotates both the top `a` and `b` nodes to the bottom of their stacks, if it's the cheapest move
{
...
static void	rev_rotate_both(node **a,
								node **b,
								node *cheapest_node) //Define a function that rotates both the bottom `a` and `b` nodes to the top of their stacks, if it's the cheapest move
{
	while (*b != cheapest_node->target_node
